    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h1>Health Insurance (Mediclaim)</h1>
                <ul class="breadcrumb">
                    <li><a href="index.php"><i class="fas fa-home"></i> Home</a></li>
                    <!-- <li><a href="#">Pages</a></li> -->
                      <li><a href="gic.php"></i> General Insurance</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 tab-navs">
                    <ul id="tabs" class="nav nav-tabs">
                        <li class="nav-item">
                            <a href="vehicle.php" class="nav-link"><i class="fas fa-angle-right"></i> Vehicle
                                Insurance</a>
                        </li>
                        <li class="nav-item">
                            <a href="travel.php" class="nav-link"><i class="fas fa-angle-right"></i> Travel
                                Insurance</a>
                        </li>
                        <li class="nav-item">
                            <a href="health.php" class=" nav-link"> <i class="fas fa-angle-right"></i>
                                Health Insurance</a>
                        </li>
                        <li class="nav-item">
                            <a href="pa.php" class="active nav-link"> <i class="fas fa-angle-right"></i>
                                Perttsnol Accident Insurance</a>
                        </li>
                        <!-- <li class="nav-item">
                ...
                <div class="col-lg-9">
                    <div class="col-lg-6 col-md-12 info" style="float:left;">
                        <h4>Health Insurance (Mediclaim)</h4>
                        <p>Health Insurance covers hospitalization expenses for Illness/Diseases/Injury.</p>

                        <h5>Expenses covered under the policy are:</h5>
                        <ul class="angle-double-right">
                            <li>Cost of treatment ,which includes room rent, nursing expenses, medical practitioner’s
                                charges, medicines, blood, oxygen, anesthesia, diagnostic and pathological tests,
                                operation theater charges, chemotherapy, dialysis, pacemaker, artificial limits etc, fix
                                amount of ambulance charges to cure from the disease.</li>
                            <li>30 days Pre Hospitalization & 60 days Post Hospitalization expenses
                                Over all expense limits are capped as per policy conditions.
                                For complete details, please click on this link:</li>
                        ...
                        <ul class="my" style="color: darkmagenta;">
                            ...
                            <li><a href="pa.php">Personal Accident</a></li>
                            <!-- <li></li> -->
                        </ul>
                    ...
                    <div class="col-lg-6 col-md-12 thumb" style="float:right; padding-bottom: 10px;">
                        <img src="assets/img/Health-ins.jpg" alt="Thumb">
                    </div>
