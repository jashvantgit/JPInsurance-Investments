    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <h1>Perttsnol Accident Insurance</h1>
                <ul class="breadcrumb">
            ...
            <div class="row">
                <div class="col-lg-3 tab-navs">
                    <ul id="tabs" class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a href="travel.php" class="nav-link"><i class="fas fa-angle-right"></i> Travel Insurance</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-lg-9">
                    <div class="col-lg-6 col-md-12 info" style="float:left;">
                          <h4>Accident Insurance (Personal Accident)</h4>
                        <h5>Personal Accident Insurance provides following benefits:</h5>
                        <ul class="angle-double-right">
                            <li>Policy sum insured in case of Accidental Death.</li>
                            <li>Permanent Partial Disability (PPD) – as per disability percentage.</li>
                            <li>Permanent Total Disability (PTD) – as per disability percentage.</li>
                            <li>Temporary Total Disability (TTD) – weekly benefits for being on leave due to accident.
                            </li>
                            <p>For complete details, please click on this link:</p>
                        </ul>
                    ...
                    <div class="col-lg-6 col-md-12 thumb" style="float:right; padding-bottom: 10px;">
                        <img src="assets/img/injury-claim.jpg" alt="Thumb">
                    </div>
